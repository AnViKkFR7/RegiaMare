      ...
      <section className="about-cta-section">
          <div className="about-cta">
            ...
            <div className="about-contact">
              <a href="mailto:info@regiamare.com" className="contact-button" data-track-event="about_email_click">
              ...
              <a href="tel:+34669887791" className="contact-button" data-track-event="about_phone_click">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
